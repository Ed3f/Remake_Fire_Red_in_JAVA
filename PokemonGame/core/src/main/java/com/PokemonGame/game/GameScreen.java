...
public class GameScreen implements Screen, InputProcessor {
    ...
    private List<String> pokemon_encounter= new ArrayList<>();
    ...
    public GameScreen(PokemonGame game, Player player) {
    ...
    public void respawn() {
        ...
        if (player.getPokemon().get(0).getHealth() < 1) {
            fight = false;
            misty.getPokemon().setHealth(misty.getPokemon().getMaxHealth());
            loadMap = load.get("Map/house.tmx");
            location = "home";
            player.setPosition(100, 610);
                    ...
                    if (Intersector.overlaps(playerRect, triggerRect)) {
                        ...
                        if (object.getName().equalsIgnoreCase("pokeCenter")) {
                            ...
                            if (foundPokemon()) {
                                ...
                                pokemon_encounter.add(pokemon.getName());
